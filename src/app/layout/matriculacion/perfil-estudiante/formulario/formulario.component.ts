...
export class FormularioComponent implements OnInit {
  ...
  @ViewChild('cuerpoHojaVida1') cuerpoHojaVida1: ElementRef;
  @ViewChild('pieHojaVida1') pieHojaVida1: ElementRef;
  @ViewChild('cuerpoHojaVida2') cuerpoHojaVida2: ElementRef;
  @ViewChild('pieHojaVida2') pieHojaVida2: ElementRef;
  ...
  getFormulario() {
    ...
    this.service.get('estudiantes/formulario/' + this.user.id).subscribe(
      response => {
        ...
        console.log(this.matricula.fecha);
        ...
        html2canvas(this.pieHojaVida1.nativeElement).then(canvasPie1 => {
          ...
          html2canvas(this.cuerpoHojaVida2.nativeElement).then(canvasCuerpo2 => {
            ...
            html2canvas(this.pieHojaVida2.nativeElement).then(canvasPie2 => {
              ...
              const nombresParticipante = this.matricula.participante.apellido1 + ' ' + this.matricula.participante.apellido2
                + ' ' + this.matricula.participante.nombre1 + ' ' + this.matricula.participante.nombre2;
              doc.save('FORMULARIO-MATRICULA-' + nombresParticipante + '-' + this.matricula.participante.identificacion + '.pdf');
              // doc.autoPrint();
