...
var FormularioComponent = /** @class */ (function () {
    ...
    FormularioComponent.prototype.updateEstudiante = function () {
        var _this = this;
        this.service.update('estudiantes/update_perfil', { 'estudiante': this.estudiante, 'informacion_estudiante': this.participante })
    ...
    FormularioComponent.prototype.getParticipanteLoad = function () {
        var _this = this;
        this.spinner.show();
