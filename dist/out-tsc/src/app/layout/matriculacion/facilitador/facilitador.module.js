...
var FacilitadorModule = /** @class */ (function () {
    function FacilitadorModule() {
    }
    FacilitadorModule = __decorate([
        NgModule({
            imports: [CommonModule, FacilitadorRoutingModule, FormsModule, PdfViewerModule],
            declarations: [FacilitadorComponent]
        })
    ], FacilitadorModule);
    return FacilitadorModule;
}());
export { FacilitadorModule };
//# sourceMappingURL=facilitador.module.js.map