...
var PerfilEstudianteComponent = /** @class */ (function () {
    function PerfilEstudianteComponent(spinner, service) {
    ...
    PerfilEstudianteComponent.prototype.getMatricula = function () {
        var _this = this;
    ...
    PerfilEstudianteComponent.prototype.getEstudiante = function () {
        var _this = this;
        this.spinner.show();
        ...
        this.service.get('estudiantes/' + this.user.id).subscribe(function (response) {
            ...
            _this.informacionParticipante = response['informacion_estudiante'];
            //this.validateEstudiante(response['estudiante'], response['informacion_estudiante']);
            _this.spinner.hide();
        }, function (error) {
            _this.spinner.hide();
        });
    };
    PerfilEstudianteComponent.prototype.validateEstudiante = function (estudiante, informacionEstudiante) {
        this.errors = '';
    ...
    PerfilEstudianteComponent.prototype.getBarcodeData = function (text, size) {
    ...
    PerfilEstudianteComponent.prototype.generateSolicitudMatricula = function (datos, detalle) {
        if (this.errors === '') {
            if (datos['codigo']) {
    ...
    PerfilEstudianteComponent.prototype.getCertificadoMatricula = function (matricula) {
        var _this = this;
    ...
    PerfilEstudianteComponent.prototype.getColumns = function () {
        return [
    ...
    PerfilEstudianteComponent.prototype.getheaderStyles = function () {
        var headerStyle = {
    ...
    PerfilEstudianteComponent.prototype.getbodyStyles = function () {
        var bodyStyle = {
            fillColor: [255, 255, 255],
            textColor: 0,
            fontSize: 8
    ...
    PerfilEstudianteComponent.prototype.getalternateRowStyles = function () {
    ...
    PerfilEstudianteComponent.prototype.updateFecha = function (event) {
...
export { PerfilEstudianteComponent };
//# sourceMappingURL=perfil-estudiante.component.js.map