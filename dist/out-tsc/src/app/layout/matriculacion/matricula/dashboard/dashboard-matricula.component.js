...
var DashboardMatriculaComponent = /** @class */ (function () {
    function DashboardMatriculaComponent(spinner, service) {
        this.spinner = spinner;
        this.service = service;
        this.chart = [];
    }
    DashboardMatriculaComponent.prototype.ngOnInit = function () {
    ...
    DashboardMatriculaComponent.prototype.getMatriculadosCount = function () {
        var _this = this;
    ...
    DashboardMatriculaComponent.prototype.drawMatriculasCount = function (matriculados) {
        var _this = this;
    ...
    DashboardMatriculaComponent.prototype.ngAfterViewInit = function () {
        var _this = this;
    ...
    ], DashboardMatriculaComponent.prototype, "graficosCarreras", void 0);
    __decorate([
        ViewChildren('graficosInstitutos'),
        __metadata("design:type", QueryList)
    ], DashboardMatriculaComponent.prototype, "graficosInstitutos", void 0);
    DashboardMatriculaComponent = __decorate([
        Component({
    ...
    return DashboardMatriculaComponent;
}());
export { DashboardMatriculaComponent };
//# sourceMappingURL=dashboard-matricula.component.js.map